...
(function () {
    ...
    // ── Gallery Carousel ────────────────────────────────────
    const carousel  = document.getElementById('sec-carousel');
    const track     = document.getElementById('sec-carousel-track');
    const dotsWrap  = document.getElementById('sec-car-dots');
    const prevBtn   = document.querySelector('.sec-car-arrow--prev');
    const nextBtn   = document.querySelector('.sec-car-arrow--next');
    const slides    = Array.from(document.querySelectorAll('.sec-carousel-slide'));
    ...
    function renderDots() {
        ...
        for (let i = 0; i < pages; i++) {
            ...
            dot.className = 'sec-car-dot' + (i === current ? ' active' : '');
    ...
    // ── Lightbox ────────────────────────────────────────────
    const lightbox  = document.getElementById('sec-lightbox');
    const lbImg     = document.getElementById('sec-lb-img');
    const lbCounter = document.getElementById('sec-lb-counter');
    const lbPrev    = document.querySelector('.sec-lb-prev');
    const lbNext    = document.querySelector('.sec-lb-next');
    const lbClose   = document.querySelector('.sec-lb-close');
