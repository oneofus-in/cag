...
<section class="hero" id="hero">
	<div class="hero-stage">
		<div class="hero-frame">
			...
			<div class="hero-dimension" aria-hidden="true"><span>תכנון מדויק · ייצור ישראלי</span></div>

			<div class="hero-content">
				<div class="hero-eyebrow">תוצרת ישראלית · מאז 2008</div>
				<h1>
					<span class="hero-line-1">א.ג. קרוואנים</span>
					<span class="hero-line-2 gradient-text-light">מבני לינה ומתחמי תיירות <br>בהתאמה אישית כחול לבן</span>
				</h1>
				<p class="hero-text">
מבנים ומתחמים, פוד טראקים ופתרונות למגזר הביטחוני
ללקוחות פרטיים, עסקים ורשויות במבנים – משלב התכנון ועד ההקמה בשטח
				</p>
				<div class="hero-actions">
					<a href="#models" class="btn btn-ghost">
						כל הדגמים
	...
	<div class="container">
		<div class="models-head" data-anim="fade-up">
			<div class="models-head-text">
				...
				<h2>מבני לינה <span class="gradient-text">בייצור מקומי</span></h2>
				<p>ארבעה דגמים מובילים בייצור כחול-לבן — תכנון, עיצוב וייצור ברמה הגבוהה ביותר, עם חשיבה מדוייקת על כל פרט ואפשרות לביצוע התאמות לצרכים שלכם.</p>
			</div>
			<div class="models-head-ctas">
				<a href="#contact" class="models-head-cta">
					<span>בקשו הצעת מחיר</span>
					<i class="fa-solid fa-arrow-left"></i>
				</a>
				<a href="<?php echo esc_url( home_url( '/kachol-lavan/' ) ); ?>" class="models-head-cta">
					<span>מידע נוסף</span>
					<i class="fa-solid fa-arrow-left"></i>
				</a>
			</div>
...
<section class="section about" id="about">
	<div class="container about-grid">
		<div class="about-text" data-anim="fade-right">
			<span class="eyebrow">מתחמי נופש ותיירות | קראוונים | מבנים למגורים</span>
			<h2>בניית מתחמי לינה ותיירות עם כל הנדרש <span class="gradient-text">לאירוח מושלם</span></h2>
			<p>
				בא.ג נגררים וקראוונים אנו מתכננים ומייצרים מתחמי אירוח ומבנים בהתאמה אישית.
				לאורך השנים צברנו ניסיון בליווי תהליכים ופרויקטים מורכבים מקצה לקצה – מתכנון ועד הקמה בשטח.
				הפתרונות שלנו מותאמים למטרות ותנאי השטח ויוצרים חוויה של חופש, שלווה וסטייל מקומי המתחבר לנוף ולאנשים.
			</p>
			...
			<div class="card-actions">
				...
				<a href="<?php echo esc_url( home_url( '/about-us/' ) ); ?>" class="btn btn-outline">מידע נוסף</a>
			</div>
		</div>
		...
		<div class="about-media" data-anim="fade-left">
			...
			<div class="media-badge">
				...
				<div>
					<strong>בהתאמה לתנאי השטח</strong>
					<small>פרויקט מקצה לקצה</small>
				</div>
			</div>
		</div>
	</div>
	...
	<div class="container">
		<div class="foodtrack-grid">
			...
			<div class="foodtrack-text" data-anim="fade-left">
				<span class="eyebrow">פוד טראקים | א.ג נגררים</span>
				<h2>פוד טראקים ניידים ונייחים <span class="gradient-text">בהתאמה אישית</span></h2>
				<p>
					תכנון, עיצוב ובניית פוד טראקים ניידים ונייחים בהתאמה מלאה לצרכי הלקוח. הפודטראקים שלנו מתאימים לעסקים, לקוחות פרטיים, עיריות ורשויות ויכולים לשמש כפתרונות למגוון רחב של צרכים — ביניהם אירועים, עסקים ומתחמי נופש ותיירות — פתרון מקצועי, יעיל ונוח ברמה הגבוהה ביותר.
				</p>
				<p>
					כל פוד טראק מתוכנן ומיוצר כאן בא.ג נגררים, בייצור מקומי כחול לבן ובהתאמה אישית מלאה. אנו מדייקים כל פרט – מהמערכות ועד לנגרות ולאחסון – לפי התכנון, מטרות ואופי הפרויקט.
				</p>
				...
				<div class="card-actions">
					<a href="#contact" class="btn btn-primary">צור קשר <i class="fa-solid fa-arrow-left"></i></a>
					<a href="<?php echo esc_url( home_url( '/foodtrucks/' ) ); ?>" class="btn btn-outline">מידע נוסף</a>
				</div>
			</div>
		</div>
	</div>
...
<section class="section authorities" id="authorities">
	<div class="auth-bg" aria-hidden="true">
		<img src="<?php echo esc_url( get_theme_file_uri( 'assets/img/services-bath.jpg' ) ); ?>" alt="">
		<div class="auth-bg-overlay"></div>
	</div>
	<div class="container">
		<div class="auth-card" data-anim="zoom-in">
			<div class="auth-text">
				<span class="eyebrow light">רשויות | מועצות | עיריות | קיבוצים</span>
				<h2>פתרונות לרשויות ועיריות</h2>
				<p>
					א.ג קראוונים מספקת פתרונות מבניים וקראוונים לרשויות מקומיות, עיריות וגופים ציבוריים, לצרכים מגוונים — מבני ציבור, משרדים, כיתות לימוד, מבני שירות ופתרונות ייעודיים נוספים. המבנים מתוכננים ומיוצרים בהתאם לדרישות הרשות והתקנים הרלוונטיים, תוך התאמה מלאה לצרכים, לתנאי השטח, למאפייני הפרויקט ולתקציב.
				</p>
				<div class="card-actions">
					<a href="#contact" class="btn btn-white">צור קשר <i class="fa-solid fa-arrow-left"></i></a>
					<a href="<?php echo esc_url( home_url( '/kachol-lavan/' ) ); ?>" class="btn btn-ghost">מידע נוסף</a>
				</div>
			</div>
...
<section class="section security" id="security-sector">
	<div class="container">
		<div class="section-head" data-anim="fade-up">
			<span class="eyebrow">מגזר הביטחוני</span>
			<h2>פתרונות ייעודיים לגופי <span class="gradient-text">ביטחון</span></h2>
			<p>תכנון וייצור נגררים ומבני לינה לגופי ביטחון, צבא ומשטרה. הפתרונות מותאמים לתנאי שטח ולצרכים מבצעיים, בדגש על אמינות, בטיחות ויכולת תפקוד בתנאים מורכבים.</p>
		</div>
...
<section class="section catalog" id="catalog">
	<div class="container">
		<div class="section-head" data-anim="fade-up">
			<span class="eyebrow">קראוונים ומבני לינה</span>
			<h2>הדגמים <span class="gradient-text">המובילים</span> של<br>א.ג קראוונים</h2>
		</div>

		<div class="catalog-grid">
			<div class="catalog-text" data-anim="fade-right">
				<p>
					א.ג קראוונים מתמחה בייבוא ובייצור קראוונים ומבנים איכותיים ומציעה מגוון רחב של פתרונות מגורים בסטנדרטים הגבוהים ביותר.
				</p>
				<p>
					המבנים שלנו כוללים קראוונים מייבוא היצרנים הטובים בעולם, לצד מבני לינה ומתחמים בייצור מקומי כחול-לבן תוך הקפדה על איכות, עמידות והתאמה מלאה לתקנים ולצרכים.
				</p>
				<p>
					הצוות שלנו בא.ג קראוונים זמין עבורכם לכל אורך הדרך ומעניק ייעוץ מקצועי, אמין ומקיף, במטרה לספק פתרון איכותי, מדויק ועמיד לאורך זמן.
				</p>
				<p>
					הפתרונות שלנו מתאימים למגוון רחב של שימושים, בהם: מתחמי לינה, מבנים לרשויות מקומיות ועיריות, מתחמי תיירות ונופש, מבנים למגורים וקראוונים לטיולים ופנאי.
				</p>
				<a href="https://wa.me/972505500180" class="btn btn-primary">
					<i class="fa-brands fa-whatsapp"></i> להתכתבות עם נציג
				</a>
			</div>

			<div class="catalog-tabs" data-anim="fade-left">
				<div class="tabs-head">
					<button class="tab-btn active" data-tab="local">ייצור מקומי כחול לבן</button>
					<button class="tab-btn" data-tab="import">דגמים מייבוא</button>
				</div>
...
<section class="section articles" id="articles">
	<div class="container">
		...
		<div class="section-head" data-anim="fade-up">
			<span class="eyebrow">מידע ותוכן נוסף</span>
			<h2>בלוג, ניוזלטרים <span class="gradient-text">וכתבות</span></h2>
		</div>
...
<section class="section social-strip" id="videos">
	<div class="container">
		<div class="social-head" data-anim="fade-up">
			<div>
				<span class="eyebrow">עקבו אחרינו ברשתות החברתיות</span>
				<h2>הפוסטים <span class="gradient-text">האחרונים</span> שלנו</h2>
			</div>
