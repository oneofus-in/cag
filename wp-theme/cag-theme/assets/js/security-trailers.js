...
(function () {
    ...
    // ── Gallery Carousel ────────────────────────────────────
    const carousel  = document.getElementById('st-carousel');
    const track     = document.getElementById('st-carousel-track');
    const dotsWrap  = document.getElementById('st-car-dots');
    const prevBtn   = document.querySelector('.st-car-arrow--prev');
    const nextBtn   = document.querySelector('.st-car-arrow--next');
    const slides    = Array.from(document.querySelectorAll('.st-carousel-slide'));
    ...
    function renderDots() {
        ...
        for (let i = 0; i < pages; i++) {
            ...
            dot.className = 'st-car-dot' + (i === current ? ' active' : '');
    ...
    // ── Lightbox ────────────────────────────────────────────
    const lightbox  = document.getElementById('st-lightbox');
    const lbImg     = document.getElementById('st-lb-img');
    const lbCounter = document.getElementById('st-lb-counter');
    const lbPrev    = document.querySelector('.st-lb-prev');
    const lbNext    = document.querySelector('.st-lb-next');
    const lbClose   = document.querySelector('.st-lb-close');
